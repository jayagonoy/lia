...
(function($, UI) {
    ...
    var Search = function(element, options) {
        ...
        this.dropdown = $('<div class="uk-dropdown uk-dropdown-search uk-scrollable-box"><ul class="uk-nav uk-nav-search"></ul></div>').appendTo(this.form).find('.uk-nav-search');
            ...
            if (data === false) {
                ...
                if (data.results && data.results.length > 0) {
                    ...
                    $(data.results).each(function(i) {
                        ...
                        var item = $('<li><a href="#" data-uk-modal="{target:\'#results\'}">' + this.title + '</a></li>').data('choice', this);
